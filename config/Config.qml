...
Singleton {
    ...
    function serializeServices(): var {
        return {
            ...
            nightColor: services.nightColor,
            nightColorTemp: services.nightColorTemp,
            nightColorSchedule: services.nightColorSchedule,
            nightColorFrom: services.nightColorFrom,
            nightColorTo: services.nightColorTo,
